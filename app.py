...
happy_card = dbc.Card(
    [
        dbc.CardBody(
            [
                html.Span("Highest score of 2022", className="card-title"),
                html.H3(
                    "Finland",
                    className="card-text",
                ),
                dbc.CardImg(src="/assets/fin.jpeg", top=True, style={'width': '30%'}),
                html.H6("7.27"),
            ]
        ),
    ],
...
sad_card  = dbc.Card(
    [
        dbc.CardBody(
            [
                html.Span("Lowest score of 2022", className="card-title"),
                html.H3(
                    "Afganistan",
                    className="card-text",
                ),
                dbc.CardImg(src="/assets/afg.png", top=True, style={'width':'30%'}),
                html.H6("1.28"),
            ]
        ),
    ],
...
app.layout = html.Div([
    ...
    html.Header([
        html.H1('World happiness, 2015 - 2022'),
    ]),
    html.Div([
    ...
    html.Div([
        ...
        html.H2('Life leader score, 2022'),
    ...
    html.Div([
        ...
        html.Div([
         html.Div([
            html.H4('Choose countries you want to see on the graph',style={'padding':'.5%'}),
    ...
    html.Div([
        ...
        html.P('In next part you will gain more insight about how factors change over two chosen years for the countries selected above. '),
        ...
        ],style={'display': 'flex','padding':'30px 0px 15px 0px'}),
        html.Div([
            html.Div([left_table], style={'width': '45%', 'margin':'auto'}),
            html.Div([right_table], style={'width': '45%', 'margin':'auto'})
        ],style={'display': 'flex','padding':'30px 0px 85px 0px'}),
        html.Div([
        html.H2('Life Leader explaind by 6 factors'),
    ...
    ],style={'background-color':'#290336','color':'#eee'}),
])
